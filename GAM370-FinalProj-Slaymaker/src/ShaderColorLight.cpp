...
void ShaderColorLight::SetPointLightParameters(const Vect& pos, float r, const Vect& att, const Vect& amb, const Vect& dif, const Vect& sp)
{
...
void ShaderColorLight::SendFog(const float& start, const float& range, const float& height, const Vect& color)
{
	Data_FogParams fp;
	fp.FogStart = start;
	fp.FogRange = range;
